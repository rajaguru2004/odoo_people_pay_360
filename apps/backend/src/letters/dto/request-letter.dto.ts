...
export class RequestLetterDto {
  @ApiProperty({
    ...
    description: 'A LetterTemplate key: SALARY_CERTIFICATE | NOC | EXPERIENCE | EMBASSY',
  })
  @IsString()
  @MaxLength(50)
  templateKey: string;
  ...
  @ApiPropertyOptional({ description: 'Why the letter is needed; it appears in the text' })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  purpose?: string;
