 ...
 *
 * Sibling to `sample-data.muscat-payroll.ts`, which owns the payroll story.
 ...
 * locked payroll run. Anyone added without bank details is a FUTURE joiner, so
 * they are on no payroll run; the extra payroll runs are older periods in states
 * that are not LOCKED, so the locked run is untouched.
 *
 ...
 * Muscat runs are LOCKED — correct for a closed month, and empty for every tab
 * on the approvals screen.
 *
 * These are OLDER periods, never the locked one: a demo that finds a
 * PENDING_APPROVAL run for the same month as a LOCKED one would be showing two
 * contradictory truths about one payroll.
 */
...
// ─────────────────────────────────────────────────────────────────────────────
// 3. A future joiner: no contract yet, legacy bank data only
// ─────────────────────────────────────────────────────────────────────────────
 ...
 * someone without an active contract. Both states are BLOCKING pre-flight
...
// ─────────────────────────────────────────────────────────────────────────────
// 4. A decided termination, so the history tab is not empty
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// 5. A completed leave carry-forward
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// 6. A document inside the expiry alert window
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// 7. An asset still out with someone who left
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// 8. The payroll extension switches
// ─────────────────────────────────────────────────────────────────────────────
...
export async function seedMuscatCoverage(
  ...
  say('Filling the remaining Muscat screens (approvals, overtime, onboarding)…');
