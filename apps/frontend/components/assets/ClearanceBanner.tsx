 ...
 * they click it, and knows exactly which items to chase — so the rows are
 * listed, not only the count. "Blocked: 0 company assets not returned" is the
 * failure mode this has to stay clear of (R20).
 */
