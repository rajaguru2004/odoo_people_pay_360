 ...
 *
 * What is dropped, proved by `hr-recon.manual.ts` rather than assumed: four
 * screens answer /403 for HR_MANAGER — end-of-service rules, the payroll
 * calendar, bank master and its field configuration. What is added: the
 * Approvals inbox, which is HR's alone; the administrator has no such screen.
 *
