...
import { AttendanceSection, ATTENDANCE_KEYS } from '@/components/settings/AttendanceSection';
...
import { PeopleSection, PEOPLE_KEYS } from '@/components/settings/PeopleSection';
